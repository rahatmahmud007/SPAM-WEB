...
<head>
    ...
    <title>RAHAT POWER SPAM - Ultimate Control Panel</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><text y="1em" font-size="8" fill="rgba(0,212,255,0.03)">RAHAT </text></svg>');
...
<body>
    ...
    <div id="home-page" class="app-container">
        <header class="header"><
            ...
            <h1 class="main-title">RAHAT<br>POWER</h1>
        ...
        <div class="card">
            ...
            <div class="console-box" id="consoleBox">
                <div class="console-line"><span class="time">[System]</span> <span class="info">RAHAT POWER SPAM SYSTEM LOADED</span></div>
        ...
        <div class="copyright">
            <i class="fa-solid fa-skull"></i> RAHAT POWER SPAM v3.0 | Premium Unlimited Access <i class="fa-solid fa-bolt"></i>
        </div>
    </div>
    ...
    <script>
        ...
        logToConsole('💀 RAHAT POWER SPAM SYSTEM READY', 'success');
