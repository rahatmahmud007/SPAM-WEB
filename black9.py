...
def openroom(K, V):
    fields = {
        1: 2,
        2: {
            1: 1, 2: 15, 3: 5, 4: "[B][00FF00]RAHAT SIR", 5: "1", 6: 12, 7: 1, 8: 1, 9: 1, 11: 1, 12: 2, 14: 36981056,
...
def Zix1(self, player_id, key, iv):
    fields = {1: int(player_id), 2: 5, 4: 50, 5: {1: int(player_id), 2: "[00FF00]RAHAT SIR BOT V1", 3: 1}}
    return GeneRaTePk(str(CrEaTe_ProTo(fields).hex()), '0515', key, iv)
